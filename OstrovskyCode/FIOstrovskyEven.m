function [u_lj, u_lj_t, G, dGdT, dGdc, momentum, tdata] = FIOstrovskyEven(u0, T, c, M, J, x)
...
u = u0;
p_integrand = [u; u(1)].^2; %compute momentum flux
...
k = kap/xfac;
epsilon = 1;
iom = 1i*k*c + 1i*k.^3 - epsilon^2*1i./(k+eps); %eps prevents from dividing by zero
...
dGdc_integrand = ([u_lT; u_lT(1)] - [u_lT_negx; u_lT_negx(1)]).*...
    ([u_lT_x; u_lT_x(1)] - [u_lT_x_negx; u_lT_x_negx(1)]);
