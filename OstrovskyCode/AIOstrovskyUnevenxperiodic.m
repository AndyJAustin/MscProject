function [dGdu, sdata, wdata] = AIOstrovskyUnevenxperiodic(u0, u_lj, u_lj_t, T, M, J, x)
...
%
% Used for a spatially periodic Ostrovsky solution approximation and uses
% alternative formulation of objective that relies on integration over an
% entire period.
%
% Input
% -----
...
u_t_high = u_lj_t(:, J + 1);
u_t_low = u_lj_t(:, J);
w_hat = fft(u_high - u0); %initial condition
w0 = u_high - u0;
