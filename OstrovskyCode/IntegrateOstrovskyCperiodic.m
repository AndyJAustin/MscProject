function [Gk, delGk] = IntegrateOstrovskyCperiodic(qk, xfac, M, J, Symm, Constraints, pandA)
...
if isequal(Symm, true)
    ...
    [u_lj, u_lj_t, G, dGdT, p_comp, ~] = FIOstrovskyOddxperiodic(u0, T, M, J, x);
    [dGduF, ~, ~] = AIOstrovskyOddxperiodic(u_lj, u_lj_t, T, M, J, x);
end
