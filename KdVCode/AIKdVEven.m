function [dGdu, sdata, wdata] = AIKdVEven(u_lj, u_lj_t, T, M, J, x)
...
%
% Used for a spatially periodic KdV solution approximation (cnoidal solutions).
%
% Input
% -----
